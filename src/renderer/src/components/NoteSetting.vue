  ...
  <div style="padding: 20px;">
    <el-form :model="setting">
      ...
      <el-row style="padding: 5px;">
        ...
        <el-col :span="18">
          <el-input v-model="setting.screenshotDir" placeholder="请输入截图目录" :maxlength="200"></el-input>
        </el-col>
      </el-row>
      <el-row style="padding: 5px;">
        <el-col :span="6" title="保存附件的目录">附件目录：</el-col>
        <el-col :span="18">
          <el-input v-model="setting.assetsDir" placeholder="请输入附件目录" :maxlength="200"></el-input>
        </el-col>
      </el-row>
      <el-row style="padding: 5px;">
      ...
      <el-row style="padding: 5px;">
        ...
        <el-col :span="18" style="display: flex">
          <el-input v-model="setting.password" clearable placeholder="请输入访问密码" type="password" maxlength="200">
            <template #append>
              仅解锁：
      ...
      <el-row style="padding: 5px;">
        ...
        <el-col :span="18" class="ai-server" style="display: flex">
          <el-input v-model="setting.aiKey" clearable placeholder="请输入APP KEY" type="password" maxlength="200">
            <template #prefix>
              <el-select v-model="setting.aiServer" clearable placeholder="请选择AI供应商" style="width: 200px;">
